...
def create_app(test_config=None):
    ...
    if test_config is None:
        app.config["SQLALCHEMY_DATABASE_URI"] = "postgresql://fl_user:fl_user@localhost:5432/todos"
    elif test_config == "test":
        app.config["SQLALCHEMY_DATABASE_URI"] = "postgresql://fl_user:fl_user@localhost:5432/todos_test"
